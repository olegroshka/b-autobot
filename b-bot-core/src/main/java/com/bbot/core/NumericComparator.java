...
public final class NumericComparator {
    ...
    /**
     * Asserts that two numeric strings are mathematically equivalent,
     * ignoring formatting differences (commas, currency symbols, trailing zeros).
     *
     * @param label        description of the value for the assertion message
     * @param apiValue     value returned by the REST API (e.g. {@code "5937500.0"})
     * @param displayValue value shown in the grid cell (e.g. {@code "5,937,500"})
     */
    public static void assertEquivalent(String label, String apiValue, String displayValue) {
        assertEquivalent(displayValue, apiValue, label, 0, label);
    }
