...
// Deterministic mid-prices for each seeded ISIN.
// These match the design contract seed data in BLOTTER_DESIGN.md.
const MID_PRICES: Record<string, number> = {
  'US912828YJ02': 99.375,   // UST 4.25% 2034   — near par
  'XS2346573523': 101.125,  // EUR IG Corp 3.5%  — at slight premium
...
/** Returns a fresh copy of the five design-contract seed inquiries. */
  ...
  return [
    {
      ...
      refSource: null, convention: null, skewDelta: null,
      price: null, spread: null, sentPrice: null, sentSpread: null,
    },
    {
      id: 'INQ-002',
      isin: 'XS2346573523',
      description: 'EUR IG Corp 3.5% 2029',
      maturity: '2029-03-20',
      coupon: 3.500,
      notional: 5_000_000,
      side: 'SELL',
    ...
    },
    {
      id: 'INQ-003',
      isin: 'US38141GXZ20',
      description: 'Goldman Sachs 5.15% 2026',
      maturity: '2026-05-22',
      coupon: 5.150,
      notional: 8_000_000,
      side: 'BUY',
