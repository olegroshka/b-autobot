...
└── src/test/
    ...
    └── resources/
        ...
        └── features/
            ├── BondBlotter.feature          # PT-Blotter M0–M8 scenarios (38 total)
...
**Current status: 51 / 51 passing (38 blotter + 14 config-service + 12 legacy + 6 finance demo).
